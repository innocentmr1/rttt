  ...
  return (
    <div className="contact">
      <div className="contact-col">
        ...
        <p>Kindly reach out to us if you have any other enquires</p>
        <ul>
          <li>
            <i class="bx bx-envelope"></i>
            admin@roundtriptravelandtour.com
          </li>
          <li>
            <i class="bx bxs-phone-call"></i> 08124921774
          </li>
          <li>
            <i class="bx bxs-location-plus"></i>
            28 Oterubi Ogidan street, Weigh bridge bus stop, Owode-onirin,Lagos
            Nigeria.
          </li>
        </ul>
